...
export default function VentaPage() {
  ...
  const { filters, updateFilters, resetFilters, applyFilters, hasActiveFilters } = useFilters({
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-corporate-purple text-white py-12">
        <div className="container-custom">
          <h1 className="heading-2 mb-4">PROPIEDADES EN VENTA</h1>
          <p className="text-lg">Encuentra tu próximo hogar</p>
        </div>
      </div>
